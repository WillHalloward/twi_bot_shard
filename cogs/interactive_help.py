            ...
            "Statistics": [
                {
                    ...
                    "description": "Displays comprehensive server activity statistics for the specified time period.",
                ...
                {
                    "name": "stats role",
                    "syntax": "/stats role <role> [days]",
                    "short_description": "View role statistics",
                    "description": "Displays comprehensive role member activity statistics for the specified time period.",
