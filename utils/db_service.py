...
class DatabaseService(Generic[T]):
    ...
    async def get_by_field(self, session: AsyncSession, field_name: str, field_value: Any) -> List[T]:
    ...
    async def update(self, session: AsyncSession, id_value: Any, **kwargs) -> Optional[T]:
        """Update a record.
