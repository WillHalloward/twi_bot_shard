...
class ServiceContainer:
    ...
    def register_factory(self, service_id: str, factory: Callable[..., Any], singleton: bool = False) -> None:
        """
    ...
    def register_class(self, service_id: str, cls: Type[T], singleton: bool = False) -> None:
        """
    ...
    def get(self, service_id: str) -> Any:
        ...
        if service_id in self._factories:
            ...
            if self._singletons.get(service_id, False) and service_id in self._singleton_instances:
    ...
    def get_typed(self, service_id: str, expected_type: Type[T]) -> T:
        ...
        if not isinstance(service, expected_type):
            raise TypeError(f"Service '{service_id}' is not of type {expected_type.__name__}")
