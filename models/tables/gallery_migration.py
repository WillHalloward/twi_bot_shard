...
class GalleryMigration(Base):
    ...
    )  # Post title from embed
    images: Mapped[str | None] = mapped_column(
        JSON, nullable=True, default=None
    )  # Array of image URLs
    creator: Mapped[str | None] = mapped_column(
        String(200), nullable=True, default=None
    )  # Creator info (user_id or name)
    tags: Mapped[str | None] = mapped_column(
        JSON, nullable=True, default=None
    )  # Array of tags
    jump_url: Mapped[str | None] = mapped_column(
        Text, nullable=True, default=None
    )  # Discord jump URL
    target_forum: Mapped[str | None] = mapped_column(
        String(10), nullable=True, default=None
    )  # 'sfw' or 'nsfw'
    content_type: Mapped[str | None] = mapped_column(
        String(50), nullable=True, default=None
    )  # fanart, official, meme, etc.
    ...
    raw_embed_data: Mapped[str | None] = mapped_column(
        JSON, nullable=True, default=None
    )  # Full embed data
